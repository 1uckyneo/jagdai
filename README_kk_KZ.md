...
Және `create`-тің қайтару мәнінде `useCommand` жолағы бар, бұл сондай-ақ Hook. Сіз оны компонентте store-ге жіберілген command-тарды алу үшін қолдана аласыз.
