...
> Бұл, React state және event басқаруды бақылауға арналған, қайта қоныстандыру шығыны жоқ дерлік шешім.

## Jagdai деген не?

Jagdai(дыбысы `/ʒɑʁdɑj/`, Жағдай) Бұл, React state және event басқаруды бақылауға арналған, қайта қоныстандыру шығыны жоқ дерлік шешім.

- Тәртіптік React Hook API ларын пайдалануға білгенде әдісімен үйрену қиын емес, көптеген кіру-шығуларда қолайлы.
- Қайта қоныстандыру шығыны төмен, мемлекетті басқару кітапханаларын пайдаланбаған жобалар үшін, бұл шешім оңай қайта қоныстандырыла алады және керемет өнімділікті қамтамасыз етеді.
