...
Jagdai(Жағдай `/ʒɑʁdɑj/` дегенінен айтуылды) көмекші React state мен event басқару шешімі, жүйелерін қолданбау проекттері үшін терең мәні бар.

- Оңайтылған оқу қатары болмақ, стандартты React Hook API-ларын қалай қолдануға үйренген кезде қарағанда жақсы бастауға мүмкіндік береді.
- Жүйелерді қолданбау проекттер үшін қайта өңдеу оңай, артықшылықты маңызды және еңбек жинауға болады.
- көмпоненттері арасындағы event басқару жақсы және қарапайым және оңай.
- TypeScript түрлерінің тегін құралын пайдалану арқылы артықшылықтарға ие болу.
...
`useCommand` мүмкіндігі бұл: **компонент онымен қайта құрушылық туындауы мүмкін емес**
...
React арқылы бизнес дамыту кезінде тек мән тек үстінде болу қателіктері болады.
